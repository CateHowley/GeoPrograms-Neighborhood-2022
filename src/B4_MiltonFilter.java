public class B4_MiltonFilter extends World
{
   ...
   public void go()
   {
      ...
      for(int row=363; row<456; row++)    //*** this is using new getBackground
      {
         for(int col=154; col<230; col++)    //*** this is using new getBackground
         {
            ...
            if(red>25 && green >190 && blue>40) //&&green<240 && blue< 100)
            {
               plane.setPixelColor(53,125,120);
            }
            
            if((red<10 && green<10 && blue<10)  )
            {
               plane.setPixelColor(255,120,130);
            }
         }
      }
      for(int row=241; row<228; row++)    //*** this is using new getBackground
      {
         for(int col=316; col<280; col++)    //*** this is using new getBackground
         {
            plane.teleport(col,row);
